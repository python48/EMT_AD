 ...
 */
public class CalisLoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calis_login);
        // Set up the login form.
        mNameView = (AutoCompleteTextView) findViewById(R.id.name);
        mFamilyNameView = (AutoCompleteTextView) findViewById(R.id.family_name);
        mSurNameView = (AutoCompleteTextView) findViewById(R.id.sur_name);
    ...
    private void attemptLogin() {
        ...
        // TODO: check for validity of other values (name, username, surname, familyname, telephonenumber, and shit...)
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserRegisterTask( email,  password,  passwordconfirmation,  username,  name,  familyname,  surname, telephone);
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(CalisLoginActivity.this,
    ...
    public class UserRegisterTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserRegisterTask(String email, String password, String passwordConfirmation, String userName, String name, String familyName, String surName,String phoneNumber) {
            mEmail = email;
            mPassword = password;
